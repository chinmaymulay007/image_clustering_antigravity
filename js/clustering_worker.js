...
self.onmessage = function (e) {
    const { embeddings, k, threshold, previousCentroids, frozenIndices, frozenRadii } = e.data;

    try {
        const start = performance.now();
        const result = engine.updateClusters(embeddings, k, threshold, previousCentroids, frozenIndices, frozenRadii);
